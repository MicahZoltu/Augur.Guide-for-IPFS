...
## What happens to parent universe?
...
## What happens to child universes?
...
In terms of what you can do, there is no difference between winning universe and losing universe. There are no restrictions for either universe. (See [Restrictions on use]({{url_restrictions_on_use}}) for details.)
